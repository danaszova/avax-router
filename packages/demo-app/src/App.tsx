                    ...
                    <section style={{ padding: '100px 0', textAlign: 'center' }} id="features">
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '2rem' }}>
                            <div className="stat-card" style={{ textAlign: 'left' }}>
                                <h4 style={{ color: '#E84142', fontSize: '1.5rem', marginBottom: '1rem' }}>Real-Time Aggregation</h4>
                            ...
                            <div className="stat-card" style={{ textAlign: 'left' }}>
                                <h4 style={{ color: '#E84142', fontSize: '1.5rem', marginBottom: '1rem' }}>Zero Bias Routing</h4>
                                <p style={{ textTransform: 'none', fontSize: '1rem', lineHeight: '1.6', letterSpacing: '0' }}>
                                    No secret deals. No preferential treatment. Your trade goes where it gets the most value — period. Pure math, no favorites.
                                </p>
                            </div>
                            <div className="stat-card" style={{ textAlign: 'left' }}>
                                <h4 style={{ color: '#E84142', fontSize: '1.5rem', marginBottom: '1rem' }}>Built for Avalanche</h4>
                                <p style={{ textTransform: 'none', fontSize: '1rem', lineHeight: '1.6', letterSpacing: '0' }}>
                    ...
                    <section style={{ padding: '80px 0', textAlign: 'center', background: 'rgba(255,255,255,0.02)', borderRadius: '2rem', margin: '40px 0' }}>
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '3rem', padding: '0 40px' }}>
                            <div style={{ textAlign: 'center' }}>
                                <div style={{ width: '60px', height: '60px', borderRadius: '50%', background: 'rgba(232, 65, 66, 0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 1.5rem', fontSize: '1.5rem', fontWeight: 'bold', color: '#E84142' }}>1</div>
                            ...
                            <div style={{ textAlign: 'center' }}>
                                <div style={{ width: '60px', height: '60px', borderRadius: '50%', background: 'rgba(232, 65, 66, 0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 1.5rem', fontSize: '1.5rem', fontWeight: 'bold', color: '#E84142' }}>2</div>
                            ...
                            <div style={{ textAlign: 'center' }}>
                                <div style={{ width: '60px', height: '60px', borderRadius: '50%', background: 'rgba(232, 65, 66, 0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 1.5rem', fontSize: '1.5rem', fontWeight: 'bold', color: '#E84142' }}>3</div>
  ...
  />
                            ...
                            <div className="dev-text">
                                ...
                                <div className="features-small" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem' }}>
                                    <div style={{ opacity: 0.8 }}>
                                        <h4 style={{ color: '#E84142', marginBottom: '0.5rem' }}>Fully Customizable</h4>
                                        <p style={{ fontSize: '0.85rem' }}>Theme, colors, tokens — match your brand perfectly.</p>
                                    </div>
                                    <div style={{ opacity: 0.8 }}>
                                        <h4 style={{ color: '#E84142', marginBottom: '0.5rem' }}>Batteries Included</h4>
                                        <p style={{ fontSize: '0.85rem' }}>Auto AVAX wrapping, multi-hop routing, gas estimates.</p>
                                    </div>
                                    <div style={{ opacity: 0.8 }}>
                                        <h4 style={{ color: '#E84142', marginBottom: '0.5rem' }}>Open Source</h4>
                                        <p style={{ fontSize: '0.85rem' }}>Audit the code. Fork it. Build on top of it.</p>
                                    </div>
                                    <div style={{ opacity: 0.8 }}>
                                        <h4 style={{ color: '#E84142', marginBottom: '0.5rem' }}>TypeScript Native</h4>
                    ...
                    <section style={{ padding: '100px 0', textAlign: 'center' }}>
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '2rem' }}>
                            <div className="stat-card">
                                <h3 style={{ color: '#E84142', fontSize: '2rem', marginBottom: '0.5rem' }}>0.05%</h3>
                                <p style={{ fontSize: '0.85rem', opacity: 0.6 }}>Protocol Fee</p>
                            </div>
                            <div className="stat-card">
                                <h3 style={{ color: '#E84142', fontSize: '2rem', marginBottom: '0.5rem' }}>100%</h3>
                                <p style={{ fontSize: '0.85rem', opacity: 0.6 }}>Open Source</p>
                            </div>
                            <div className="stat-card">
                                <h3 style={{ color: '#E84142', fontSize: '2rem', marginBottom: '0.5rem' }}>0</h3>
                                <p style={{ fontSize: '0.85rem', opacity: 0.6 }}>Hidden Fees</p>
                            </div>
                            <div className="stat-card">
                                <h3 style={{ color: '#E84142', fontSize: '2rem', marginBottom: '0.5rem' }}>∞</h3>
