...
export interface PangolinAdapterInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "USDC"
      | "USDT"
...
export interface PangolinAdapter extends BaseContract {
  connect(runner?: ContractRunner | null): PangolinAdapter;
  waitForDeployment(): Promise<this>;

  interface: PangolinAdapterInterface;
