...
export interface IPangolinRouterInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "WAVAX"
      | "addLiquidity"
...
export interface IPangolinRouter extends BaseContract {
  connect(runner?: ContractRunner | null): IPangolinRouter;
