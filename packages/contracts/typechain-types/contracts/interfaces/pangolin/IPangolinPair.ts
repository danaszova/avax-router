...
export interface IPangolinPairInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface IPangolinPair extends BaseContract {
  connect(runner?: ContractRunner | null): IPangolinPair;
